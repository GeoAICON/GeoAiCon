...
"[project]/Desktop/piyuweb/GeoAiCon/node_modules/@splinetool/runtime/build/howler.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/*! howler.js v2.2.3 | (c) 2013-2020, James Simpson of GoldFire Studios | MIT License | howlerjs.com */ !function() {
    ...
    e.prototype = {
        ...
        _obtainHtml5Audio: function _obtainHtml5Audio() {
            ...
            return o && "undefined" != typeof Promise && (_instanceof._(o, Promise) || "function" == typeof o.then) && o.catch(function() {
        ...
        play: function play(e, o) {
            ...
            if (t._webAudio) {
                var v = function v() {
                    ...
                    var _$e = d._muted || t._muted ? 0 : d._volume;
                    m.gain.setValueAtTime(_$e, n.ctx.currentTime), d._playStart = n.ctx.currentTime, void 0 === m.bufferSource.start ? d._loop ? m.bufferSource.noteGrainOn(0, _, 86400) : m.bufferSource.noteGrainOn(0, _, s) : d._loop ? m.bufferSource.start(0, _, 86400) : m.bufferSource.start(0, _, s), l !== 1 / 0 && (t._endTimers[d._id] = setTimeout(t._ended.bind(t, d), l)), o || setTimeout(function() {
                ...
                var h = function h() {
                    ...
                    try {
                        var r = m.play();
                        if (r && "undefined" != typeof Promise && (_instanceof._(r, Promise) || "function" == typeof r.then) ? (t._playLock = !0, p(), r.then(function() {
    ...
    }()), "undefined" != ("TURBOPACK compile-time value", "undefined") && (exports.Howler = n, exports.Howl = o), ("TURBOPACK compile-time truthy", 1) ? (/*TURBOPACK member replacement*/ __turbopack_context__.g.HowlerGlobal = e, /*TURBOPACK member replacement*/ __turbopack_context__.g.Howler = n, /*TURBOPACK member replacement*/ __turbopack_context__.g.Howl = o, /*TURBOPACK member replacement*/ __turbopack_context__.g.Sound = t) : "TURBOPACK unreachable";
}();
}),
]);

//# sourceMappingURL=14306_%40splinetool_runtime_build_howler_c27baa5b.js.map