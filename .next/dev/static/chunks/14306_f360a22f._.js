...
"[project]/Desktop/piyuweb/GeoAiCon/node_modules/@splinetool/runtime/build/process.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var Module = function() {
    ...
    return function() {
        ...
        var ___cxa_throw = function(ptr, type, destructor) {
        ...
        var runDestructors = function(destructors) {
        ...
        var embind_init_charCodes = function() {
        ...
        var readLatin1String = function(ptr) {
            var ret = "";
            var c = ptr;
            while(HEAPU8[c]){
        ...
        var BindingError;
        var throwBindingError = function(message) {
        ...
        var __embind_register_bool = function(rawType, name, trueValue, falseValue) {
        ...
        var throwInstanceAlreadyDeleted = function(obj) {
            var getInstanceTypeName = function getInstanceTypeName(handle) {
                return handle.$$.ptrType.registeredClass.name;
            };
            throwBindingError(getInstanceTypeName(obj) + " instance already deleted");
        };
        var finalizationRegistry = false;
        var detachFinalizer = function(handle) {};
        var runDestructor = function($$) {
            if ($$.smartPtr) {
        ...
        var releaseClassHandle = function($$) {
            $$.count.value -= 1;
        ...
        var downcastPointer = function(ptr, ptrClass, desiredClass) {
        ...
        var getInheritedInstanceCount = function() {
            return Object.keys(registeredInstances).length;
        };
        var getLiveInheritedInstances = function() {
            var rv = [];
        ...
        var deletionQueue = [];
        var flushPendingDeletes = function() {
        ...
        var delayFunction;
        var setDelayFunction = function(fn) {
            delayFunction = fn;
            if (deletionQueue.length && delayFunction) {
                delayFunction(flushPendingDeletes);
            }
        };
        var init_embind = function() {
        ...
        var getBasestPointer = function(class_, ptr) {
            if (ptr === undefined) {
        ...
        var getInheritedInstance = function(class_, ptr) {
            ptr = getBasestPointer(class_, ptr);
            return registeredInstances[ptr];
        };
        var makeClassHandle = function(prototype, record) {
        ...
        var init_ClassHandle = function() {
            Object.assign(ClassHandle.prototype, {
                "isAliasOf": function(other) {
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, ClassHandle)) {
                        return false;
                    }
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(other, ClassHandle)) {
                        return false;
                    }
        ...
        var char_0 = 48;
        var char_9 = 57;
        var makeLegalFunctionName = function(name) {
            if (undefined === name) {
                return "_unknown";
            }
        ...
        function createNamedFunction(name, body) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({}, name, function() {
                return body.apply(this, arguments);
            })[name];
        }
        var ensureOverloadTable = function(proto, methodName, humanName) {
            if (undefined === proto[methodName].overloadTable) {
                var prevFunc = proto[methodName];
                proto[methodName] = function ensureOverloadTable() {
        ...
        var exposePublicSymbol = function(name, value, numArguments) {
        ...
        var upcastPointer = function(ptr, ptrClass, desiredClass) {
        ...
        var init_RegisteredPointer = function() {
        ...
        var replacePublicSymbol = function(name, value, numArguments) {
            if (!Module.hasOwnProperty(name)) {
        ...
        var dynCallLegacy = function(sig, ptr, args) {
        ...
        var dynCall = function(sig, ptr, args) {
            if (sig.includes("j")) {
        ...
        var embind__requireFunction = function(signature, rawFunction) {
            var makeDynCaller = function makeDynCaller() {
        ...
        var extendError = function(baseErrorType, errorName) {
            ...
            errorClass.prototype.toString = function extendError() {
        ...
        var __embind_register_class = function(rawType, rawPointerType, rawConstPointerType, baseClassRawType, getActualTypeSignature, getActualType, upcastSignature, upcast, downcastSignature, downcast, name, destructorSignature, rawDestructor) {
            name = readLatin1String(name);
        ...
        var heap32VectorToArray = function(count, firstElement) {
            var array = [];
        ...
        function newFunc(constructor, argumentList) {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(constructor, Function)) {
                throw new TypeError("new_ called with constructor type ".concat(typeof constructor === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(constructor), " which is not a function"));
            }
            var dummy = createNamedFunction(constructor.name || "unknownFunctionName", function() {});
            dummy.prototype = constructor.prototype;
            var obj = new dummy;
            var r = constructor.apply(obj, argumentList);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(r, Object) ? r : obj;
        }
        ...
        var validateThis = function(this_, classType, humanName) {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this_, Object)) {
                throwBindingError("".concat(humanName, ' with invalid "this": ').concat(this_));
            }
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this_, classType.registeredClass.constructor)) {
        ...
        var __embind_register_class_property = function(classType, fieldName, getterReturnType, getterSignature, getter, getterContext, setterArgumentType, setterSignature, setter, setterContext) {
            ...
            whenDependentTypesAreResolved([], [
                ...
                if (setter) {
                    desc.set = function() {
                        return throwUnboundTypeError("Cannot access ".concat(humanName, " due to unbound types"), [
                            getterReturnType,
                            setterArgumentType
                        ]);
                    };
                ...
                whenDependentTypesAreResolved([], setter ? [
                    ...
                    var _$getterReturnType = types[0];
                    var desc = {
                        get: function get() {
                            var ptr = validateThis(this, classType, humanName + " getter");
                            return _$getterReturnType["fromWireType"](getter(getterContext, ptr));
                        },
                        enumerable: true
                    };
                    if (setter) {
                        setter = embind__requireFunction(setterSignature, setter);
                        var _$setterArgumentType = types[1];
                        desc.set = function(v) {
                            var ptr = validateThis(this, classType, humanName + " setter");
                            var destructors = [];
                            setter(setterContext, ptr, _$setterArgumentType["toWireType"](destructors, v));
                            runDestructors(destructors);
                        };
                    }
                    Object.defineProperty(classType.registeredClass.instancePrototype, fieldName, desc);
        ...
        var __emval_decref = function(handle) {
            if (handle >= emval_handles.reserved && 0 === --emval_handles.get(handle).refcount) {
                emval_handles.free(handle);
            }
        };
        var count_emval_handles = function() {
            var count = 0;
        ...
        var enumReadValueFromPointer = function(name, width, signed) {
            switch(width){
                case 1:
                    return signed ? function enumReadValueFromPointer(pointer) {
        ...
        var requireRegisteredType = function(rawType, humanName) {
        ...
        var __embind_register_enum_value = function(rawEnumType, name, enumValue) {
        ...
        var embindRepr = function(v) {
            if (v === null) {
                return "null";
            }
            var t = typeof v === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(v);
        ...
        var floatReadValueFromPointer = function(name, width) {
            switch(width){
                case 4:
                    return function floatReadValueFromPointer(pointer) {
        ...
        var __embind_register_function = function(name, argCount, rawArgTypesAddr, signature, rawInvoker, fn, isAsync) {
        ...
        var integerReadValueFromPointer = function(name, width, signed) {
            switch(width){
                case 1:
                    return signed ? function(pointer) {
        ...
        var __embind_register_memory_view = function(rawType, dataTypeIndex, name) {
            var decodeMemoryView = function decodeMemoryView(handle) {
        ...
        var UTF8ArrayToString = function(heapOrArray, idx, maxBytesToRead) {
        ...
        var __embind_register_std_string = function(rawType, name) {
            ...
            registerType(rawType, {
                ...
                "toWireType": function(destructors, value) {
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(value, ArrayBuffer)) {
                        value = new Uint8Array(value);
                    }
                    var length;
                    var valueIsOfTypeString = typeof value == "string";
                    if (!(valueIsOfTypeString || (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(value, Uint8Array) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(value, Uint8ClampedArray) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(value, Int8Array))) {
        ...
        var UTF16ToString = function(ptr, maxBytesToRead) {
            var endPtr = ptr;
            var idx = endPtr >> 1;
        ...
        var stringToUTF16 = function(str, outPtr, maxBytesToWrite) {
        ...
        var lengthBytesUTF16 = function(str) {
            return str.length * 2;
        };
        var UTF32ToString = function(ptr, maxBytesToRead) {
            var i = 0;
            var str = "";
        ...
        var stringToUTF32 = function(str, outPtr, maxBytesToWrite) {
            if (maxBytesToWrite === undefined) {
                maxBytesToWrite = 2147483647;
            }
        ...
        var lengthBytesUTF32 = function(str) {
            var len = 0;
            for(var i = 0; i < str.length; ++i){
                var codeUnit = str.charCodeAt(i);
        ...
        var __embind_register_value_array = function(rawType, name, constructorSignature, rawConstructor, destructorSignature, rawDestructor) {
        ...
        var __embind_register_value_array_element = function(rawTupleType, getterReturnType, getterSignature, getter, getterContext, setterArgumentType, setterSignature, setter, setterContext) {
        ...
        var __embind_register_value_object = function(rawType, name, constructorSignature, rawConstructor, destructorSignature, rawDestructor) {
        ...
        var __embind_register_value_object_field = function(structType, fieldName, getterReturnType, getterSignature, getter, getterContext, setterArgumentType, setterSignature, setter, setterContext) {
        ...
        var __emval_incref = function(handle) {
            if (handle > 4) {
                emval_handles.get(handle).refcount += 1;
            }
        };
        var __emval_take_value = function(type, arg) {
        ...
        var _emscripten_memcpy_js = function(dest, src, num) {
        ...
        var ENV = {};
        var getExecutableName = function() {
            return thisProgram || "./this.program";
        };
        var getEnvStrings = function() {
        ...
        var stringToAscii = function(str, buffer) {
            for(var i = 0; i < str.length; ++i){
        ...
        var initRandomFill = function() {
            if ((typeof crypto === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(crypto)) == "object" && typeof crypto["getRandomValues"] == "function") {
                return function(view) {
                    return crypto.getRandomValues(view);
                };
            } else abort("initRandomDevice");
        };
        var randomFill = function(view) {
        ...
        var asyncLoad = function(url, onload, onerror, noRunDep) {
        ...
        var FS_createDataFile = function(parent, name, fileData, canRead, canWrite, canOwn) {
            return FS.createDataFile(parent, name, fileData, canRead, canWrite, canOwn);
        };
        var preloadPlugins = Module["preloadPlugins"] || [];
        var FS_handledByPreloadPlugin = function(byteArray, fullname, finish, onerror) {
        ...
        var FS_createPreloadedFile = function(parent, name, url, canRead, canWrite, onload, onerror, dontCreateFile, canOwn, preFinish) {
            var processData = function processData(byteArray) {
        ...
        var FS_modeStringToFlags = function(str) {
            var flagModes = {
                "r": 0,
                "r+": 2,
                "w": 512 | 64 | 1,
        ...
        var FS_getMode = function(canRead, canWrite) {
            var mode = 0;
        ...
        var FS = {
            ...
            createStream: function createStream(stream) {
                var fd = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : -1;
                if (!FS.FSStream) {
            ...
            open: function open(path, flags, mode) {
                ...
                var node;
                if ((typeof path === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(path)) == "object") {
                    node = path;
                } else {
                    path = PATH.normalize(path);
                    try {
        ...
        var doReadv = function(stream, iov, iovcnt, offset) {
            var ret = 0;
        ...
        var doWritev = function(stream, iov, iovcnt, offset) {
            var ret = 0;
            for(var i = 0; i < iovcnt; i++){
                var ptr = HEAPU32[iov >> 2];
                var len = HEAPU32[iov + 4 >> 2];
        ...
        var _strftime = function(s, maxsize, format, tm) {
            var leadingSomething = function leadingSomething(value, digits, character) {
            ...
            var leadingNulls = function leadingNulls(value, digits) {
                return leadingSomething(value, digits, "0");
            };
            var compareByDay = function compareByDay(date1, date2) {
                function sgn(value) {
            ...
            var getFirstWeekStartDate = function getFirstWeekStartDate(janFourth) {
            ...
            var getWeekBasedYear = function getWeekBasedYear(date) {
        ...
        InternalError = Module["InternalError"] = /*#__PURE__*/ function(Error1) {
            "use strict";
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_inherits$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(InternalError, Error1);
            function InternalError(message) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_class_call_check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, InternalError);
                var _this;
                _this = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_call_super$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, InternalError, [
                    message
                ]);
        ...
        BindingError = Module["BindingError"] = /*#__PURE__*/ function(Error1) {
            "use strict";
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_inherits$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(BindingError, Error1);
            function BindingError(message) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_class_call_check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, BindingError);
                var _this;
                _this = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$piyuweb$2f$GeoAiCon$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_call_super$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, BindingError, [
                    message
                ]);
        ...
        var ___wasm_call_ctors = function() {
            return (___wasm_call_ctors = wasmExports["L"])();
        };
        var _malloc = Module["_malloc"] = function(a0) {
            return (_malloc = Module["_malloc"] = wasmExports["M"])(a0);
        };
        var _free = Module["_free"] = function(a0) {
            return (_free = Module["_free"] = wasmExports["N"])(a0);
        };
        var ___getTypeName = function(a0) {
            return (___getTypeName = wasmExports["P"])(a0);
        };
        var __embind_initialize_bindings = Module["__embind_initialize_bindings"] = function() {
            return (__embind_initialize_bindings = Module["__embind_initialize_bindings"] = wasmExports["Q"])();
        };
        var ___errno_location = function() {
            return (___errno_location = wasmExports["__errno_location"])();
        };
        var stackSave = function() {
            return (stackSave = wasmExports["R"])();
        };
        var stackRestore = function(a0) {
            return (stackRestore = wasmExports["S"])(a0);
        };
        var stackAlloc = function(a0) {
            return (stackAlloc = wasmExports["T"])(a0);
        };
        var ___cxa_increment_exception_refcount = function(a0) {
            return (___cxa_increment_exception_refcount = wasmExports["__cxa_increment_exception_refcount"])(a0);
        };
        var ___cxa_is_pointer_type = function(a0) {
            return (___cxa_is_pointer_type = wasmExports["U"])(a0);
        };
        var dynCall_jiji = Module["dynCall_jiji"] = function(a0, a1, a2, a3, a4) {
            return (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["V"])(a0, a1, a2, a3, a4);
        };
        var dynCall_viijii = Module["dynCall_viijii"] = function(a0, a1, a2, a3, a4, a5, a6) {
            return (dynCall_viijii = Module["dynCall_viijii"] = wasmExports["W"])(a0, a1, a2, a3, a4, a5, a6);
        };
        var dynCall_iiiiij = Module["dynCall_iiiiij"] = function(a0, a1, a2, a3, a4, a5, a6) {
            return (dynCall_iiiiij = Module["dynCall_iiiiij"] = wasmExports["X"])(a0, a1, a2, a3, a4, a5, a6);
        };
        var dynCall_iiiiijj = Module["dynCall_iiiiijj"] = function(a0, a1, a2, a3, a4, a5, a6, a7, a8) {
            return (dynCall_iiiiijj = Module["dynCall_iiiiijj"] = wasmExports["Y"])(a0, a1, a2, a3, a4, a5, a6, a7, a8);
        };
        var dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = function(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            return (dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = wasmExports["Z"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
        };
        Module["ccall"] = ccall;
        var calledRun;
...
//# sourceMappingURL=14306_f360a22f._.js.map