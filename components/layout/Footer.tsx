          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 lg:col-span-3">
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm flex flex-col text-base-content/70">
                <li><Link href="https://geoaicon.vercel.app/" target="_blank" className="hover:text-primary transition-colors">GeoAICon 2026</Link></li>
                <li><Link href="https://geoaicon-2025.vercel.app/" target="_blank" className="hover:text-primary transition-colors">GeoAICon 2025</Link></li>
