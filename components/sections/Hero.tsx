      ...
      <div className="container-standard relative z-10 w-full">
        <StaggerContainer className="max-w-4xl space-y-10">
          ...
          <StaggerItem className="flex flex-col sm:flex-row gap-4 pt-4">
            <a href="#editions" className="btn btn-primary rounded-btn btn-lg px-8 border-transparent hover:border-transparent text-primary-content font-medium transition-transform hover:-translate-y-1 hover:shadow-lg">
              Explore Editions
            </a>
            <a href="#ecosystem" className="btn btn-outline border-base-300 rounded-btn btn-lg px-8 bg-base-100 text-base-content hover:bg-base-200 hover:border-base-300 transition-transform hover:-translate-y-1">
              View the Network
            </a>
          </StaggerItem>
