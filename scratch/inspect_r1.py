...
path = r"c:\Users\Piyush Rawat\Desktop\piyuweb\GeoAiCon\public\LogoLoop\r1.png"
if os.path.exists(path):
    img = Image.open(path).convert("RGBA")
    width, height = img.size
    print(f"r1.png | Size: {img.size} | Mode: {img.mode}")
    ...
    print("Top 10 colors in r1.png:")
    for color, count in counter.most_common(10):
        print(f"Color: {color} | Count: {count}")
else:
    print("r1.png does not exist at path.")
